          ...
          <Row>
            <Col md={6}>
              <Form.Group className="mb-3">
                ...
                <Form.Control type="text" placeholder="Enter company name" name="courierCompany" onChange={handleInputChange} />
              </Form.Group>
            </Col>
          ...
          <Row>
            <Col md={4}>
              <Form.Group className="mb-3">
                ...
                <Form.Control type="number" placeholder="Number of boxes" name="numberOfBoxes" onChange={handleInputChange} />
              </Form.Group>
            </Col>
