...
const NewBranch = () => {
  ...
  const handleSubmit=async()=>{
    ...
    try{
      if(!street || !state || !country || !city || !pincode || !contactPersonName || !contactPersonNumber){
        message.error('Please provide all the details')
        return ;
      }
      const res=await axios.post(`${host}/branch/create-branch`,{street,state,country,city,pincode,contactPersonName,contactPersonNumber},{
        headers:{
