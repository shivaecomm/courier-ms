...
const createBranchController = async (req, res) => {
    try {
        const { street, city, pincode, state, country, contactPersonName, contactPersonNumber } = req.body;

        // Check if all required fields are provided
        if (!street || !city || !pincode || !state || !country || !contactPersonName || !contactPersonNumber) {
